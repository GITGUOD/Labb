...
series = pd.read_csv("means-collections-True-Data2.csv", index_col=0).squeeze("columns")
#series = pd.read_csv("means-collections-False-Data2.csv", index_col=0).squeeze("columns")
#series = pd.read_csv("means-mysort-True-Data2.csv", index_col=0).squeeze("columns")
#series = pd.read_csv("means-mysort-False-Data2.csv", index_col=0).squeeze("columns")
